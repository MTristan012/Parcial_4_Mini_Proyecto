...
<body>
  ...
  <div class="card container position-absolute top-50 start-50 translate-middle rounded-4" style="max-width: 22rem;">
    ...
    <div class="card-body">
      <h5 class="card-title">Join thousans of learnes from around the world</h5>
      <p class="card-text">Master web development by making real-life projects. There are multiple paths for you to
        choose</p>
      <?php 
    ...
    <div class="card-body">
      <form action="" method="post">
        <div class="input-group mb-3">
          ...
          <input type="email" class="form-control" aria-label="" placeholder="Email" name="emailSignIn">
        </div>
        ...
        <div class="input-group mb-3">
          ...
          <input type="password" class="form-control" aria-label="" placeholder="Password" name="passwordSignIn">
        </div>

        <input class="btn btn-primary" type="submit" name="btnSignIn" value="Start coding now"/>
      </form>
    </div>
